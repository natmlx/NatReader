...
namespace NatSuite.Readers.Internal {
    ...
    public static class Bridge {
        ...
        [DllImport(Assembly, EntryPoint = @"NRMediaPath")]
        public static extern void Path (this IntPtr reader, [MarshalAs(UnmanagedType.LPStr)] StringBuilder dstString);
        ...
        public static extern IntPtr CreateMP4Reader ([MarshalAs(UnmanagedType.LPStr)] string path);
